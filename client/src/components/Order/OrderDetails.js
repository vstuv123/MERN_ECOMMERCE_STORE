...
import { getOrderDetails } from "../../store/orderSlice/orderReducers";
                ...
                {order.orderItems &&
                  order.orderItems.map((item) => (
                    <div key={item.product}>
                      ...
                      <span>
                        {item.quantity} X Rs. {item.price && item.price > 0 ? item.price : item.originalPrice } ={" "}
                        <b>Rs. {item.price && item.price > 0 ? item.price : item.originalPrice * item.quantity}</b>
                      </span>
                    </div>
                  ))}
              </div>
